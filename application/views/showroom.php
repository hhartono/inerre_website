    ...
    <body class="appear-animate">
        ...
        <div class="page" id="top">
            ...
            <div class="home-section fullwidth-slider bg-dark" id="home">
                ...
                <!-- Slide Item -->
                <section class="home-section bg-scroll bg-dark-alfa-30" data-background="/assets/images/full-width-images/test-bg.jpg">
                ...
                <!-- Slide Item -->
                <section class="home-section bg-scroll bg-dark-alfa-50" data-background="/assets/images/full-width-images/section-bg-10.jpg">
                    <div class="js-height-full container">
                ...
                <!-- Slide Item -->
                <section class="home-section bg-scroll bg-dark-alfa-30" data-background="/assets/images/full-width-images/section-bg-9.jpg">
                    <div class="js-height-full container">
                ...
                <!-- Slide Item -->
                <section class="home-section bg-scroll bg-dark-alfa-30" data-background="/assets/images/full-width-images/section-bg-8.jpg">
                    <div class="js-height-full container">
                    ...
                    <div class="row multi-columns-row">
                        ...
                        <div class="col-md-3 col-lg-3 mb-60 mb-xs-40 wow fadeIn" data-wow-delay="0.1s" data-wow-duration="2s">
                            <div class="post-prev-img">
                                <a href="shop-single.html"><img src="/assets/images/shop/shop-prev-1.jpg" alt="" /></a>
                        ...
                        <div class="col-md-3 col-lg-3 mb-60 mb-xs-40 wow fadeIn" data-wow-delay="0.2s" data-wow-duration="2s">
                            <div class="post-prev-img">
                                <a href="shop-single.html"><img src="/assets/images/shop/shop-prev-2.jpg" alt="" /></a>
                            </div>
                            <div class="post-prev-title font-alt align-center">
                        ...
                        <div class="col-md-3 col-lg-3 mb-60 mb-xs-40 wow fadeIn" data-wow-delay="0.3s" data-wow-duration="2s">
                            <div class="post-prev-img">
                                <a href="shop-single.html"><img src="/assets/images/shop/shop-prev-3.jpg" alt="" /></a>
                            </div>
                            <div class="post-prev-title font-alt align-center">
                        ...
                        <div class="col-md-3 col-lg-3 mb-60 mb-xs-40 wow fadeIn" data-wow-delay="0.4s" data-wow-duration="2s">
                            <div class="post-prev-img">
                                <a href="shop-single.html"><img src="/assets/images/shop/shop-prev-4.jpg" alt="" /></a>
                            </div>
                            <div class="post-prev-title font-alt align-center">
                        ...
                        <div class="col-md-7 mb-sm-40">
                            ...
                            <div class="work-full-media mt-0 white-shadow wow fadeInUp">
                                <ul class="clearlist work-full-slider owl-carousel">
                                    ...
                                    <li>
                                        <img src="/assets/images/portfolio/full-project-2.jpg" alt="" />
                                    </li>
                                </ul>
                            </div>
                            <!-- End Gallery -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-lg-offset-1">
                            ...
                            <div class="work-full-media mt-0 white-shadow wow fadeInUp">
                                <ul class="clearlist work-full-slider owl-carousel">
                                    <li>
                                        <img src="/assets/images/promo-4.png" alt="" />
                                    </li>
                                    <li>
                                        <img src="/assets/images/portfolio/full-project-4.jpg" alt="" />
                                    </li>
                                </ul>
                            </div>
                            <!-- End Work Gallery -->
            ...
            <!-- Section -->
            <section class="page-section bg-dark-alfa-70 bg-scroll" data-background="/assets/images/full-width-images/section-bg-16.jpg">
                <div class="container relative">
                ...
                <div class="container relative">
                    ...
                    <div class="row multi-columns-row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-md-50 wow fadeIn" data-wow-delay="0.1s" data-wow-duration="2s">
                            ...
                            <div class="post-prev-img">
                                <a href="blog-single-sidebar-right.html"><img src="/assets/images/blog/post-prev-1.jpg" alt="" /></a>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-md-50 wow fadeIn" data-wow-delay="0.2s" data-wow-duration="2s">
                            ...
                            <div class="post-prev-img">
                                <a href="blog-single-sidebar-right.html"><img src="/assets/images/blog/post-prev-2.jpg" alt="" /></a>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-md-50 wow fadeIn" data-wow-delay="0.3s" data-wow-duration="2s">
                            ...
                            <div class="post-prev-img">
                                <a href="blog-single-sidebar-right.html"><img src="/assets/images/blog/post-prev-3.jpg" alt="" /></a>
                            </div>
