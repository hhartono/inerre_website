            ...
            <section class="page-section" id="about">
                <div class="container relative">
                    ...
                    <h2 class="section-title font-alt align-left mb-70 mb-sm-40">
                        ...
                        <a href="/about" class="section-more right">More about INERRE <i class="fa fa-angle-right"></i></a>
                    ...
                    <div class="row alt-features-grid">
                        ...
                        <div class="col-sm-2">
                            <div class="alt-features-item align-center">
                                ...
                                <h3 class="alt-features-title font-alt">1. Consultation</h3>
                            </div>
                        </div>
                        <!-- End Features Item -->
                        ...
                        <div class="col-sm-2">
                            <div class="alt-features-item align-center">
                                ...
                                <h3 class="alt-features-title font-alt">2. Measurement</h3>
                            </div>
                        </div>
                        <!-- End Features Item -->
                        ...
                        <div class="col-sm-2">
                            <div class="alt-features-item align-center">
                                ...
                                <h3 class="alt-features-title font-alt">3. Design</h3>
                            </div>
                        </div>
                        <!-- End Features Item -->
                        ...
                        <div class="col-sm-2">
                            <div class="alt-features-item align-center">
                                ...
                                <h3 class="alt-features-title font-alt">4. Production</h3>
                            </div>
                        </div>
                        <!-- End Features Item -->
