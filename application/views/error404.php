...
<html>
    <head>
        <title>INERRE interior &mdash; 404 Not Found</title>
                            ...
                            <div class="hs-cont">
                                ...
                                <div class="hs-wrap">
                                    ...
                                    <div class="local-scroll">                                        
                                        <a href="/home" class="btn btn-mod btn-w btn-round btn-small"><i class="fa fa-angle-left"></i> Back To Home Page</a>
                                    </div>
                ...
                <div class="full-wrapper relative clearfix">
                    ...
                    <div class="inner-nav desktop-nav">
                        <ul class="clearlist scroll-nav local-scroll">
                            <li class="active"><a href="mailto:info@inerre.com"><i class="fa fa-envelope"></i> info@inerre.com</a></li>
                            <li><a href="#"><i class="fa fa-phone"></i>+62 22 423 2200</a></li>
